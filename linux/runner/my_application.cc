...
static void my_application_activate(GApplication* application) {
  ...
  // Use the installed hicolor icon (see tool/install-desktop.sh) so the dock,
  // alt-tab and window all show the Iwatch mark.
  gtk_window_set_icon_name(window, "io.github.papito0x1.iwatch");
  gtk_window_set_default_icon_name("io.github.papito0x1.iwatch");
